...
class Twig_Tests_ExpressionParserTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function getTestsForArray()
    {
        return array(
            // simple array
            array('{{ [1, 2] }}', new Twig_Node_Expression_Array(
                array(
            ...
            // simple hash
            array('{{ {"a": "b", "b": "c"} }}', new Twig_Node_Expression_Array(
                array(
            ...
            // hash in an array
            array('{{ [1, {"a": "b", "b": "c"}] }}', new Twig_Node_Expression_Array(
                array(
                  new Twig_Node_Expression_Constant(0, 1),
                  new Twig_Node_Expression_Constant(1, 1),
            ...
            // array in a hash
            array('{{ {"a": [1, 2], "b": "c"} }}', new Twig_Node_Expression_Array(
                array(
                  new Twig_Node_Expression_Constant('a', 1),
                  new Twig_Node_Expression_Array(
                      array(
